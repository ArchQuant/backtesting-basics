...
class BacktestBase(object):
    ...
    ==========
    symbol: str
        RIC of the inancial instrument to be used
    start: str
    ...
    get_date_price:
        returns the date and price for the given bar (eod index)
    print_balance:
    ...
    def get_date_price(self, bar):
        ''' Return date and price for bar (i.e. the EOD index).
        '''
    ...
    def place_buy_order(self, bar, units=None, amount=None):
        ...
        If units are provided, buy units. Otherwise, buy amount.
        '''
        date, price = self.get_date_price(bar)
        if units is None:
...
if __name__ == '__main__':
    ...
    bb.plot_data()
    dirpath = os.path.dirname(__file__) 
    filepath = os.path.join(dirpath, '../output/backtestbaseplot.png')
